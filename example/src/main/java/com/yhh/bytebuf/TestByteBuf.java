...
//        byte[] b2 = {9, 8, 7, 6};
//        // 大小就固定了 b1的长度
//        ByteBuffer wrap1 = ByteBuffer.wrap(b1);
//        ByteBuffer wrap2 = ByteBuffer.wrap(b2);
//        byteBufferComposite(wrap1, wrap2);
...
//        readAllData();
    ...
    public static void byteBufCompositeArray() {
        ...
        //将字节读到该数组中  指针不会移动
        compBuf.getBytes(compBuf.readerIndex(), array1);
...
//        getXXX()和setXXX()方法将对writerIndex和readerIndex无影响
        ...
        CompositeByteBuf byteBufs = compBuf.readBytes(array3);
    ...
    public static void write() {
        ...
        ByteBuf byteBuf = buffer.readBytes(buffer.writerIndex());
        // byte[] array = byteBuf.array();  Exception in thread "main" java.lang.UnsupportedOperationException: direct buffer
